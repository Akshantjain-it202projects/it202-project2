    ...
    var L = "carousel",
        ...
        at = function () {
            ...
            return t.next = function () {
                ...
                if (o = t === M ? (n = z, i = X, U) : (n = Y, i = G, B), l && p(l).hasClass(Q))
                    this._isSliding = !1;
                    ...
                    if (p(this._element).hasClass(V)) {
                        ...
                        p(s).removeClass(Q), p(l).addClass(Q), this._isSliding = !1, p(this._element).trigger(u);
                    h && this.cycle()
                }
            ...
            computeStyle: {
                ...
                fn: function (t, e) {
                    ...
                    var s,
                        ...
                        A = void 0,
                        O = void 0;
                    if (O = "bottom" === S ? "HTML" === b.nodeName ? -b.clientHeight + T.bottom : -w.height + T.bottom : T.top, A = "right" === D ? "HTML" === b.nodeName ? -b.clientWidth + T.right : -w.width + T.right : T.left, E && I)
        ...
        gn = function () {
            ...
            return t.toggle = function (t) {
                ...
                if (this._isShown && this._config.backdrop) {
                    ...
                    }), n && m.reflow(this._backdrop), p(this._backdrop).addClass(cn), !t)
                        return;
                    if (!n)
                        return void t();
